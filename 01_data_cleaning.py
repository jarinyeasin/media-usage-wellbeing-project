...
Student Media Usage & Mental Wellbeing Survey (n=56)
=============================================================

This script loads the raw Excel file, cleans messy entries,
renames columns, creates composite scores, and saves a clean
CSV that all other scripts will use.
