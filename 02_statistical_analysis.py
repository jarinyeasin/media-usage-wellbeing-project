...
Student Media Usage & Mental Wellbeing Survey
=============================================================

Covers:
  - Descriptive statistics (means, std, distributions)
  - Pearson correlation (screentime × negative impact)
  - Independent-samples t-test (gender differences)
  - One-way ANOVA (across screentime groups)
  - Multiple linear regression (predict wellbeing impact)
